...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_NAME = "sup_name";
    private static final String COLUMN_PRICE = "sup_price";
    private static final String COLUMN_DESCRIPTION = "sup_description";
    private static final String COLUMN_IMAGE = "sup_image";
    ...
    public Cursor retrieveimage(String id){
        String imageretirveQUERY = " SELECT * FROM " + TABLE_NAME + " WHERE " + COLUMN_ID + " LIKE " + "'" + id + "'";
        SQLiteDatabase db = this.getReadableDatabase();
