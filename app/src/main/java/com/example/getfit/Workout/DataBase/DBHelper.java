package com.example.getfit.Workout.DataBase;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_ENTRIES =
                "CREATE TABLE IF NOT EXISTS " + WorkOutMaster.WorkOuts.TABLE_NAME + "(" +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            db.execSQL("DROP TABLE IF EXISTS "+WorkOutMaster.WorkOuts.TABLE_NAME);
            onCreate(db);
    }

    public long insertInfo(String woId, String woName, String woPckg, int cal, int duration, String steps){
        ...
        long result = db.insert(WorkOutMaster.WorkOuts.TABLE_NAME,null,values);
        return result;
    }
    ...
    public Cursor getAllData(){
        ...
        String query = "SELECT * FROM "+WorkOutMaster.WorkOuts.TABLE_NAME;
    ...
    public List readAllInfo(){
        ...
        Cursor cursor = db.query(WorkOutMaster.WorkOuts.TABLE_NAME,
                projection,
                null,
                null,
                null,
    ...
    public WorkOut readOneWorkOutInfo(String req){
        ...
        String query = "SELECT * FROM "+WorkOutMaster.WorkOuts.TABLE_NAME + " WHERE "
    ...
    public boolean deleteWorkOutInfo(String name){
        ...
        int result = db.delete(WorkOutMaster.WorkOuts.TABLE_NAME,selection,selectionArgs);
    ...
    public int updateWorkOutInfo(String woId, String woName, String woPckg, int cal, int duration, String steps){
        ...
        try{
        int count = db.update(
                WorkOutMaster.WorkOuts.TABLE_NAME,
                values,
                selection,
                selectionArgs
        );
