...
public class ViewExercise extends AppCompatActivity {
    ...
    Button viewExe_btn1;//calorie burnOut calculate button
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewExe_btn1 = findViewById(R.id.viewExe_btn1);
        viewExe_btn2 = findViewById(R.id.viewExe_btn2);
        viewExe_etv1 = findViewById(R.id.viewExe_etv1);
        viewExe_tv1 = findViewById(R.id.viewExe_tv1);
    ...
    public void showNotification(View view){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this,CHANNEL_ID)
                ...
                .setContentTitle("GET FIT APP Notification")
